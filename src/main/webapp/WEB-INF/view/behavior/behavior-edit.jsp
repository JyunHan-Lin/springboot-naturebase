		...
		<div class="card shadow-sm">
			...
			<div class="card-body">
				<sp:form method="post" modelAttribute="behaviorDTO"
					action="/ornibase/discuss/behavior/${behaviorDTO.discussId}/edit/${behaviorDTO.behaviorId}">
					...
					<div class="d-flex justify-content-between mt-4">
						...
						<a href="/ornibase/discuss/behavior/${discussDTO.discussId}/list" class="btn btn-outline-secondary">查看紀錄清單</a>
					</div>
